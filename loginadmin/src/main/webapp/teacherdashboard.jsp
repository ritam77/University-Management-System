...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
        ...
        <a href="tlogout.jsp" class="w3-bar-item w3-button">Logout</a>
    </div>
...
final String pass = "";
final String Query="select * from ttoall order by notice,tname desc";
...
while(rs.next()){
	%>
<tr>
<td><%=rs.getString("tname")%> To Student:-<%=rs.getString("notice")%>
</tr>
<% 
}
}catch(Exception e)
