        ...
        <div class="w3-container">
            ...
            <div class="form-popup" id="myForm">
              <form action="process3.jsp" method="post" class="form-container">
                ...
                <label for="Roll"><b>Roll No / Student ID:</b></label>
                <input type="text"  placeholder="Enter Roll Number" name="sid" required>
                
                <label for="course"><b>Course ID :</b></label>
                <input type="text"  placeholder="Enter Course" name="course_code" required>
                
                <label for="sem"><b>Year :</b></label>
                <input type="text"  placeholder="Enter Year" name="year" required>

                <label for="sem"><b>Password :</b></label>
...
<td><a href="update.jsp?sid=<%=rs.getString("sid")%>">Edit</a></td>
<td><a href="delete.jsp?sid=<%=rs.getString("sid")%>">Delete</a></td>
</tr>
<% 
}
}catch(Exception e)
