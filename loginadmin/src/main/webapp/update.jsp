...
<body>
    ...
    <div id="main">
        ...
        <div class="w3-container">
            ...
            String Query="select * from student_details where sid = '"+sid+"'";
            ...
            %>
                ...
                <input type="text"  placeholder="Enter Course" name="course_code" value="<%= rs.getString("course_code")%>" required>
                
                <label for="sem"><b>Year</b></label>
                <input type="text"  placeholder="Enter Year" name="year" value="<%= rs.getString("year")%>" required>
                
                <label for="password"><b>Password</b></label>
                <input type="text"  placeholder="Enter Password" name="password" value="<%= rs.getString("password")%>" required>
    ...
    try{
    if(fname!=null && lname!=null && sid1!=null && course_code!=null && year!=null && password!=null){
    	String Queryt = "update student_details set fname = ?,lname =?,course_code= ?,year= ?,password=? where sid = '"+sid1+"'";
    	...
    	String Query1 = "update loginall set password=? where email = '"+sid1+"'";
